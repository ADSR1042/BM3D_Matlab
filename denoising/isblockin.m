...
%function res =  isblockin(height,width,block_length,block_reference_index,i,j)
function res =  isblockin(height,width,step,block_length,block_reference_index,i,j)
